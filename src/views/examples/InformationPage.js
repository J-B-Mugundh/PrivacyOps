        ...
        <section className="section section-lg" id="education">
          <Container>
            ...
            <Row className="row-grid justify-content-center">
              <Col md="6">
                <h3 className="text-center">Privacy Regulations Compliance</h3>
              ...
              <Col md="6">
                <h3 className="text-center">Ethical Data Usage</h3>
                <Card className="card-video">
                  <iframe
                    width="100%"
                    height="315"
            ...
            <Row className="row-grid justify-content-center">
              <Col md="6">
                <h3 className="text-center">Digital Forensics</h3>
                <Card className="card-video">
                  <iframe
                    width="100%"
                    height="315"
                    src="https://www.youtube.com/embed/inWWhr5tnEA?si=9mrWubd1B0Khq4gY"
                    title="Digital Forensics Video"
                    frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
              ...
              <Col md="6">
                <h3 className="text-center">Data Protection Laws</h3>
                <Card className="card-video">
                  <iframe
                    width="100%"
                    height="315"
                    src="https://www.youtube.com/embed/NJBBE_SN90A?si=86u-zu05P93J4pvN"
                    title="Data Protection Laws Video"
                    frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
            ...
            <Row className="row-grid justify-content-center">
              <Col md="6">
                <h3 className="text-center">GDPR Compliance</h3>
                <Card className="card-video">
                  <iframe
                    width="100%"
                    height="315"
                    src="https://www.youtube.com/embed/inWWhr5tnEA?si=9mrWubd1B0Khq4gY"
                    title="GDPR Compliance Video"
                    frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
              ...
              <Col md="6">
                <h3 className="text-center">Cybersecurity Ethics</h3>
                <Card className="card-video">
                  <iframe
                    width="100%"
                    height="315"
                    src="https://www.youtube.com/embed/NJBBE_SN90A?si=86u-zu05P93J4pvN"
                    title="Cybersecurity Ethics Video"
                    frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
            ...
            <Row className="row-grid justify-content-center">
              <Col md="6">
                <h3 className="text-center">Information Security Policies</h3>
                <Card className="card-video">
                  <iframe
                    width="100%"
                    height="315"
                    src="https://www.youtube.com/embed/inWWhr5tnEA?si=9mrWubd1B0Khq4gY"
                    title="Information Security Policies Video"
                    frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                  ></iframe>
